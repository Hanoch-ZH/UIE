...
def get_file_paths(root, split='train', paired=True):
    if split == 'train':
        train_a, train_b = [], []
        if paired:
            ...
            for sub_dir in sub_dirs:
                train_a += sorted(glob.glob(os.path.join(root, 'Paired', sub_dir, 'trainA') + "/*.*"))
                train_b += sorted(glob.glob(os.path.join(root, 'Paired', sub_dir, 'trainB') + "/*.*"))
        else:
            train_a = sorted(glob.glob(os.path.join(root, 'Unpaired', 'trainA') + "/*.*"))
